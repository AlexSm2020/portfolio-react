    ...
    return(
      <div style={{width: '100%', margin: 'auto'}}>
        ...
        <div className="social-links">
          ...
          {/* LinkedIn */}
          <a href="https://www.linkedin.com/in/aref-smiley-61941757" rel="noopener noreferrer" target="_blank">
            <i className="fa fa-linkedin-square" aria-hidden="true" />
          </a>

          {/* Github */}
          <a href="https://github.com/AlexSm2020" rel="noopener noreferrer" target="_blank">
